        ...
        {onEmergencyUnlock && (
          <div className="mt-8 animate-fade-in-delay-3">
            <button
              ...
              className="px-6 py-3 bg-red-600 hover:bg-red-700 text-white rounded-lg text-sm font-medium transition-colors opacity-80 hover:opacity-100 shadow-lg border-2 border-red-500 hover:border-red-400"
            >
              🔓 Déverrouiller manuellement
            </button>
            <p className="text-xs text-gray-500 mt-2">
              Si l'application ne se charge pas, cliquez ici
            </p>
          </div>
        )}
      </div>
